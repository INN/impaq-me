  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved publisher as @publisher" do
        ...
        post :create, {:publisher => { "paypal_link" => "invalid value" }}, valid_session
        assigns(:publisher).should be_a_new(Publisher)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested publisher" do
        ...
        Publisher.any_instance.should_receive(:update).with({ "paypal_link" => "MyString" })
        put :update, {:id => publisher.to_param, :publisher => { "paypal_link" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the publisher as @publisher" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Publisher.any_instance.stub(:save).and_return(false)
        put :update, {:id => publisher.to_param, :publisher => { "paypal_link" => "invalid value" }}, valid_session
        assigns(:publisher).should eq(publisher)
      end
